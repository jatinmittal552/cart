  ...
  return (
    <div className="border border-gray-200">
        ...
        <div className="px-8 py-4">
            ...
            <div className="flex justtify-between items-center mt-4">
                <h2 className="font-medium text-red-400 text-xl mr-2">${price}</h2>
                <div className="flex gap-1 items-center bg-blue-400 text-white px-5 py-3 cursor-pointer hover:bg-blue-600" onClick={addProduct}>
